...
docker-compose  -f ../base/docker-compose.yml  -f docker-compose.yml run mysql_hybrid_mapbench-datadistributor sh /bsbm/scripts/mapbench-datadistributor/parseToMySQLHybrid.sh
