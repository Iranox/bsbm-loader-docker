...
MYSQL3=`ping -c 1 mysql_horizontal_mysql3 | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
...
java -jar bsbmloader-jar-with-dependencies.jar -importJdbc -user root -password password -sourceUrl jdbc:mysql://${MYSQL1}:3306/benchmark -targetUrl jdbc:mysql://${MYSQL3}:3306/benchmark -database benchmark  -tables product -horizontal -x 2 -y 0 -column nr
...
java -jar bsbmloader-jar-with-dependencies.jar -importJdbc -user root -password password -sourceUrl jdbc:mysql://${MYSQL1}:3306/benchmark -targetUrl jdbc:mysql://${MYSQL3}:3306/benchmark -database benchmark  -tables review -horizontal -x 2 -y 0 -column product
java -jar bsbmloader-jar-with-dependencies.jar -importJdbc -user root -password password -sourceUrl jdbc:mysql://${MYSQL1}:3306/benchmark -targetUrl jdbc:mysql://${MYSQL3}:3306/benchmark -database benchmark  -tables offer -horizontal -x 2 -y 0 -column product
