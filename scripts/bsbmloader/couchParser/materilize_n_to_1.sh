...
#java -jar bsbmloader-jar-with-dependencies.jar -materializeCouch -target ${Target2} -source ${Source2} -fk ${ForgeinKey2} -pk ${PrimaryKey2} -hostNosql ${COUCHDB_PORT_5984_TCP_ADDR} -portNosql ${COUCHDB_PORT_5984_TCP_PORT} -databaseName bsbm
